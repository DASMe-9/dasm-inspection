...
**تنبيه تسميات:** الريبو اسمه **`dasm-inspection`**؛ **الدومين العلني المعتمد** **`inspect.dasm.com.sa`**. بادئة الجداول **`inspection_`** توصف المجال في قاعدة البيانات ولا تُلزم دوميناً باسم `inspection.…`.
