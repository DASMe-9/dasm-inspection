export const metadata = {
  title: "سياسة الخصوصية — فحص DASM",
  description: "سياسة خصوصية منصّة فحص DASM الفني للمركبات.",
};
    ...
    >
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-gray-700">
        <section>
          ...
          <p>
            تحترم منصّة «فحص DASM» خصوصيتك. توضّح هذه السياسة البيانات التي
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pr-5">
            <li>معرّفات حسابك في منصّة DASM (معرّف المستخدم والمركبة).</li>
            <li>
