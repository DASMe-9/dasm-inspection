export const metadata = {
  title: "الشروط والأحكام — فحص DASM",
  description: "شروط وأحكام استخدام منصّة فحص DASM الفني للمركبات.",
};
    ...
    >
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-gray-700">
        <section>
          ...
          <p>
            باستخدامك منصّة «فحص DASM» فإنك توافق على هذه الشروط. إن لم توافق،
