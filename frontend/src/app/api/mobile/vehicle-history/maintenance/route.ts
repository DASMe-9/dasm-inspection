...
import { createMobileMaintenanceRecord } from "@/lib/api/mobile-vehicle-history";

/** POST /api/mobile/vehicle-history/maintenance */
export async function POST(request: NextRequest) {
  ...
  const result = await createMobileMaintenanceRecord(
