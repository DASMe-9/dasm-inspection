...
export const findWorkshopIdByOwnerUserId = cache(
  async (ownerUserId: string): Promise<string | null> => {
...
export const findWorkshopByOwnerUserId = cache(
  async (ownerUserId: string): Promise<Workshop | null> => {
