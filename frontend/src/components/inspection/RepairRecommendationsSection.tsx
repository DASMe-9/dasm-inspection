...
> = {
  advisory: { label: "إرشادي", cls: "bg-gray-100 text-gray-700" },
  minor: { label: "بسيط", cls: "bg-sky-100 text-sky-800" },
  major: { label: "مهم", cls: "bg-amber-100 text-amber-800" },
  critical: { label: "حرِج", cls: "bg-red-100 text-red-700" },
};
  ...
  return (
    <SectionCard title="توصيات الإصلاح">
      {recommendations.length === 0 ? (
        <p className="text-sm text-gray-500">لا توصيات إصلاح بعد.</p>
      ) : (
      ...
      {canEdit && (
        ...
        >
          ...
          <label className="block sm:col-span-2">
            <span className="text-xs font-medium text-gray-600">الوصف (اختياري)</span>
            <textarea
              name="description"
              maxLength={2000}
              rows={2}
          ...
          <label className="block">
            <span className="text-xs font-medium text-gray-600">الأهمية</span>
            <select
              name="severity"
          ...
          <label className="block">
            <span className="text-xs font-medium text-gray-600">التكلفة التقديرية (ر.س)</span>
            <input
